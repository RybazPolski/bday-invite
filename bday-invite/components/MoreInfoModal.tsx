...
import { Clock11, FilePen, HeartHandshake, MessageSquareText, ScrollTextIcon, ShirtIcon, VolumeOff, Watch, XIcon } from "lucide-react"
    ...
    <AlertDialogContent className="max-w-[50%] max-h-[90%] overflow-scroll">
        <AlertDialogHeader>
            ...
            <AlertDialogDescription className="inline-block max-h-[50%]">
                ...
                <Watch className="inline h-4"/> Prośba uno: <span className="text-primary">Mega prosimy o <u>punktualność</u>!!</span><br/>
                <span className="block mb-2"/>
                <ShirtIcon className="inline h-4"/> Dress code: <span className="text-primary">Ubierzcie się tak, abyście czuli się komfortowo. Innymi słowy ubierzcie się w taki sposób, w jaki chcecie przyjąć naszego questa - czy to z klasą, czy praktycznie, czy może oba! ^^</span><br/>
                <span className="block mb-2"/>
                ...
                <span className="block mb-2"/>
                <HeartHandshake className="inline h-4"/> Prośba dos: <span className="text-primary">Lokal musimy zostawić tak, jak go zastaliśmy. Stąd prosimy, aby ci, którzy mogą, pomogli w ogarnięciu go na koniec.</span><br/>
